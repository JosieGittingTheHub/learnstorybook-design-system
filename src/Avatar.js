...
export function Avatar({ loading, username, src, size, ...props }) {  let avatarFigure = <Icon icon="useralt" />;
  const a11yProps = {};
  ...
  return (
    <Image size={size} loading={loading.toString()} src={src} {...a11yProps} {...props}>
      {avatarFigure}
    </Image>
  );
}
